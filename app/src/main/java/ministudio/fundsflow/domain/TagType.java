...
public class TagType implements Domain {
    ...
    private static final class TagTypeInitializer implements IPersistenceInitializer {
        ...
        private static final String STMT_DROP_TABLE  = "drop table if exist tag_category";
    ...
    private static final class TagTypeCreator implements DomainCreator<TagType> {
        @Override
